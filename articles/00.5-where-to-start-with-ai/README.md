# Where to Start If You're Ready to Work With AI (But Don't Know How)

If you've read my [previous article](../00-ai-will-not-replace-your-job/) about how I got here, this is your practical next step.
...
- **Official download page:** [Visual Studio Code](https://code.visualstudio.com/)
- **Beginner-friendly YouTube guides:**
  - [VS Code Setup Walkthrough](https://youtu.be/zK1rKC7QVwk)
  - [VS Code for Beginners](https://youtu.be/ORrELERGIHs)
...
- **Official Python Download:** [python.org/downloads](https://www.python.org/downloads/)
- **YouTube Guide for Python + VS Code Setup:** [Python + VS Code Setup](https://youtu.be/8mO6QXOcpqU)

Look for:

- Installing Python
- Adding Python to PATH
- Installing the Python extension inside VS Code
