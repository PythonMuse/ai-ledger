...
copy_legacy_data.py
-------------------
Copies source files from legacy folder locations into data/raw/ for the current
period. Part of the workings-template starter kit.

HOW TO USE
----------
1. Fill in the LEGACY_FILES list with your actual file paths.
...
- data/raw/ is excluded from git. Keep it that way.
"""
